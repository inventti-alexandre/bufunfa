...
{
    public class CadastrarAgendamentoRequestExemplo : IExamplesProvider
    {
    ...
    public class AlterarAgendamentoRequestExemplo : IExamplesProvider
    {
        public object GetExamples()
        {
    ...
    public class ProcurarAgendamentoRequestExemplo : IExamplesProvider
    {
        public object GetExamples()
        {
