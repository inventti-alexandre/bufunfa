...
{
    // View model utilizado para o cadastro de um agendamento
    public class CadastrarAgendamentoViewModel
    {
        ...
        /// </summary>
        [Required(ErrorMessage = "O tipo do método de pagamento das parcelas do agendamento é obrigatório e não foi informado.")]
